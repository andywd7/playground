jQuery(document).ready(function(){Modernizr.svg||jQuery("#js-logo").attr("src",function(){return jQuery(this).attr("src").replace(".svg",".gif")}),Modernizr.inputtypes.date||jQuery("input[type=date]").addClass("js-datepicker"),jQuery("a.is-disabled").on("click",function(e){e.preventDefault()}),jQuery(".lt-ie9 .i").each(function(){var e=jQuery(this);""==e.text()&&e.addClass("i--only")}),jQuery("lt-ie10 .has-icon .i, lt-ie10 .has-icon--right .i").on("mouseover mouseleave click",function(e){var i=jQuery(this).siblings(".btn:not(:disabled)");"mouseover"==e.type?i.addClass("is-hover"):"mouseleave"==e.type?i.removeClass("is-hover"):(i.click(),console.log("clicked"))}),jQuery(".lt-ie10 .has-icon input[type=submit],lt-ie10 .has-icon--right input[type=submit]").on("click",function(){console.log("clicked")}),jQuery(function(){})});
;jQuery(".toggle_chkbx").on("change",function(){jQuery(this).attr("aria-pressed","true"==jQuery(this).attr("aria-pressed")?"false":"true"),jQuery(".flyout_overlay").toggleClass("is-active")}),jQuery(".navbar_flyout .btn--link").on("click",function(){var e=jQuery(this),t=e.innerHeight();e.parent().toggleClass("is-active"),jQuery(".navbar_flyout .btn--link").not(this).parent().removeClass("is-active"),e.parent().hasClass("is-active")?jQuery(".flyout_inner").animate({scrollTop:e.parent().prevAll().length*t},600):jQuery(".flyout_inner").animate({scrollTop:0},800)}),jQuery("body").on("click",".flyout_overlay.is-active",function(){jQuery(this).removeClass("is-active"),setTimeout(function(){jQuery(".flyout_overlay, .navbar_dd").removeClass("is-active"),jQuery(".flyout_inner").animate({scrollTop:0})},400),jQuery(".flyout_wrapper .toggle_chkbx").removeAttr("checked").attr("aria-pressed","false")}),jQuery(".list-collapsable_header a").on("click",function(e){e.preventDefault(),jQuery(this).parent().toggleClass("is-active")});
