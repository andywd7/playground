...
(function ($, window, document) {
    ...
    var pluginName = "accessibleMegaMenu",
        defaults = {
            uuidPrefix: "js-mm", // unique ID's are required to indicate aria-owns, aria-controls and aria-labelledby
            menuClass: "", // default css class used to define the megamenu styling
            topNavItemClass: "js-nav-item", // default css class for a top-level navigation item in the megamenu
            panelClass: "js-sub-nav", // default css class for a megamenu panel
            panelGroupClass: "nav", // default css class for a group of items within a megamenu panel
            hoverClass: "is-hover", // default css class for the hover state
            focusClass: "is-focus", // default css class for the focus state
